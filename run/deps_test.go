...
func TestNewDependencyRun_Serial(t *testing.T) {
	t.Parallel()
	...
	t.Run("returns error", func(t *testing.T) {
		...
		require.EqualError(t, err, "running pkg.package-operator.run/cardboard/run.TestNewDependencyRun_Serial.func1.1(): banana")
	})
...
func TestNewDependencyRun_Parallel(t *testing.T) {
	t.Parallel()
	t.Run("returns errors", func(t *testing.T) {
		...
		assert.Contains(t, errStrings,
			"running pkg.package-operator.run/cardboard/run.TestNewDependencyRun_Parallel.func1.1(): banana")
		assert.Contains(t, errStrings,
			"running pkg.package-operator.run/cardboard/run.TestNewDependencyRun_Parallel.func1.2(): banana")
	})
